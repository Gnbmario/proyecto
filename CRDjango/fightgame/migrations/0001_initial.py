    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('finish_date', models.DateTimeField(verbose_name='Fecha/hora final')),
                ('category', models.IntegerField(default=0, verbose_name='Categoróa')),
                ('fighters', models.ManyToManyField(to='fightgame.Fighter', verbose_name='Luchadores')),
            ],
            options={
                'verbose_name': 'Torneo',
            },
