...
class Tournament(models.Model):
    ...
    finish_date = models.DateTimeField('Fecha/hora final')
    category = models.IntegerField('Categoróa', default=0)
...
class Combat(models.Model):
    ...
    def __str__(self):
        return '{} vs {}'.format(self.fighter1.alias, self.figther2.alias)
